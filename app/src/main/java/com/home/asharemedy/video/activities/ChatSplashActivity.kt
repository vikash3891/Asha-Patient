...
import com.home.asharemedy.video.utils.longToast
...
class ChatSplashActivity : BaseActivity() {
    private val TAG = ChatSplashActivity::class.java.simpleName

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.chat_spalsh)
    ...
    private fun showAndroidOverlayPermissionsSettings() {
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M && !Settings.canDrawOverlays(this@ChatSplashActivity)) {
