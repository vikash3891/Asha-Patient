...
public class ActivityPayUMain extends AppCompatActivity {
        ...
        environmentSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                /*if (environmentSpinner.getSelectedItem().equals("Production")) {
                    Toast.makeText(ActivityPayUMain.this, getString(R.string.use_live_key_in_production_environment), Toast.LENGTH_SHORT).show();
