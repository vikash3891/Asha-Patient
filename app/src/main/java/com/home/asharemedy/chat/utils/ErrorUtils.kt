package com.home.asharemedy.chat.utils
...
private val NO_SERVER_CONNECTION = AshaRemedyApp.getInstance().getString(R.string.no_server_connection)
...
fun showSnackbar(view: View, @StringRes errorMessageResource: Int, e: Exception?,
    ...
    return if (noConnection || timeout) {
        ...
        showSnackbar(view, AshaRemedyApp.getInstance().getString(errorMessageResource), actionLabel, clickListener)
    } else if (error == "") {
...
private fun showSnackbar(view: View, message: String,
    ...
    if (clickListener != null) {
        ...
        snackbar.setActionTextColor(ContextCompat.getColor(AshaRemedyApp.getInstance(), R.color.color_blue_qb))
        snackbar.setTextColor(ContextCompat.getColor(AshaRemedyApp.getInstance(), R.color.color_light_blue_qb))
    }
    snackbar.show()
    return snackbar
}
